...
minfragsize=250                             # lower boundary of loci fragment's size
maxfragsize=350                             # upper boundary of loci fragment's size
...
**Note**: takes ~1 hr to run on 1 core; 126GB RAM. Remaining steps run in less than a minute each.
...
locinum=1000                                # loci number to sample
readsnum=100000                             # reads number
