...
cladelabels(t, c("pteridoides", "thalictroides 2", "gaudichaudii", "thalictroides 1" ), c(61, 69, 64, 52), cex=0.8, offset=1.2, wing.length=0.7)

painted<-paintSubTree(t, 61,"pteridoides")
painted<-paintSubTree(painted,69,"thalictroides 2")
painted<-paintSubTree(painted,64,"gaudichaudii")
painted<-paintSubTree(painted,52,"thalictroides 1")

plot(painted,ftype="off",lwd=3)
## no colors provided. using the following legend:
##         0   clade 1   clade 2   clade 3 
##   "black" "#DF536B" "#61D04F" "#2297E6"
cladelabels(tree, c("clade 1","clade 2","clade 3"), paintc(47,41,29), wing.length=0, offset=0.5)
