...
par(mfrow = c(3, 3))
for(i in 1:60){
  barplot(propOut[[i]][3:5,3], ylim = c(0,1), axes = FALSE, xlab = "ratios", ylab = "proportions", xaxt = 'n')
...
barplot(p[3:5,3], ylim = c(0,1), axes = FALSE, xlab = "ratios", ylab = "proportions")
axis(1, at = c(0.7, 1.9, 3.1), c("1:1", "2:1", "3:1"))
axis(2)
box()
segments(c(0.7, 1.9, 3.1), p[3:5,1], c(0.7, 1.9, 3.1), p[3:5,5])
