...
# thalictroides
willeerd.tiplabels(tip = c(1:17, 19, 35:37, 39:61), pch = 21, col = "#000000", bg = "#AAFFC3", cex = 1.2)

# sp.
willeerd.tiplabels(tip = c(34, 54), pch = 21, col = '#000000', bg = "#000075", cex = 1.2)

# cornuta
willeerd.tiplabels(tip = c(29, 30:32), pch = 21, col = '#000000', bg = "#F58231", cex = 1.2)

# pteridoides
willeerd.tiplabels(tip = c(22, 24:28), pch = 21, col = '#000000', bg = "#FFE119", cex = 1.2)

# gaudichaudii
willeerd.tiplabels(tip = c(18, 23), pch = 21, col = '#000000', bg = "#E6194B", cex = 1.2)

# richardii
willeerd.tiplabels(tip = c(20, 21, 38), pch = 21, col = '#000000', bg = "#3CB44B", cex = 1.2)

# Acrostichum
willeerd.tiplabels(tip = 33, pch = 21, col = '#000000', bg = "#800000", cex = 1.2)

legend(1.5, 250, legend = c("C. thalictroides", "C. gaudichaudii", "C. cornuta", "C. pteridoides", "C. richardii", "C. sp.", "A. aureum"), pch = 19, cex = 1.5, col = c("#AAFFC3", "#E6194B", "#F58231", "#FFE119", "#3CB44B", "#000075", "#800000"))
